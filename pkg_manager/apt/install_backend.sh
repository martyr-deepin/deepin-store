#!/bin/sh
cp ./dbus/com.linuxdeepin.softwarecenter.service /usr/share/dbus-1/system-services/ 
echo "Copy .service file to /usr/share/dbus-1/system-services/"

cp ./dbus/com.linuxdeepin.softwarecenter.policy /usr/share/polkit-1/actions/
echo "Copy .policy file to /usr/share/polkit-1/actions/"

cp ./dbus/com.linuxdeepin.softwarecenter.conf /etc/dbus-1/system.d/
